...
var application app.RESTApp

func TestMain(m *testing.M) {
	application.Initialize("postgres", "pq_password", "products_db")
...
func addProducts(count int) {
	...
	for i := 0; i < count; i++ {
		application.DB.Exec("INSERT INTO products(name, price) VALUES($1, $2)", "Product "+strconv.Itoa(i), (i+1.0)*10)
	}
}
